/**@brief: Este programa muestra el uso de C embebido
 * Manejo de variables globales
 * Paso de parametros
 * - Manejo de Numeros
 * - Manejo de Memoria
 * Retorno desde ensambaldor
 * @device: DSPIC30F4013
...
short int var;
//El paso de parametros entre C y ensamblador se van guardando en los registros
//W0 , W1 ,..., W7 , despues de 8 parametros se guarda en la pila.

/**@brief: Este programa muestra el uso del convertidor Analógico Digital (ADC)
 * usando el sistema de interrupciones para realizar el monitoreo de una señal
...
int main( void ){
    ...
    U1STAbits.UTXEN = 1;   //Habilitando transmisión
